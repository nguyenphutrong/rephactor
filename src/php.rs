...
struct InternalFunctionMetadata {
    ...
    parameter_types: &'static [Option<&'static str>],
    return_type: Option<&'static str>,
    is_variadic: bool,
}

const INTERNAL_FUNCTIONS: &[InternalFunctionMetadata] = &[
    InternalFunctionMetadata {
        name: "abs",
        parameters: &["num"],
        parameter_types: &[Some("int")],
        return_type: Some("int"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "array_chunk",
        parameters: &["array", "length", "preserve_keys"],
        parameter_types: &[Some("array"), Some("int"), Some("bool")],
    ...
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("array"), Some("array")],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "array_filter",
        parameters: &["array", "callback", "mode"],
        parameter_types: &[Some("array"), None, None],
        return_type: Some("array"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "array_column",
        parameters: &["array", "column_key", "index_key"],
        parameter_types: &[Some("array"), None, None],
        return_type: Some("array"),
        is_variadic: false,
    },
    ...
    InternalFunctionMetadata {
        name: "array_fill",
        parameters: &["start_index", "count", "value"],
        parameter_types: &[Some("int"), Some("int"), None],
        return_type: Some("array"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("array"), None],
        return_type: Some("array"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        ...
        parameter_types: &[None, Some("array")],
        return_type: Some("bool"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "array_keys",
        parameters: &["array", "filter_value", "strict"],
        parameter_types: &[Some("array"), None, Some("bool")],
        return_type: Some("array"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "array_map",
        parameters: &["callback", "array", "arrays"],
        parameter_types: &[None, Some("array"), None],
        return_type: Some("array"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "array_merge",
        parameters: &["arrays"],
        parameter_types: &[Some("array")],
        return_type: Some("array"),
        is_variadic: true,
    },
    InternalFunctionMetadata {
        name: "array_pad",
        parameters: &["array", "length", "value"],
        parameter_types: &[Some("array"), Some("int"), None],
        return_type: Some("array"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("array"), Some("int")],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "array_reduce",
        parameters: &["array", "callback", "initial"],
        parameter_types: &[Some("array"), None, None],
        return_type: None,
        is_variadic: false,
    },
    ...
    InternalFunctionMetadata {
        name: "array_reverse",
        parameters: &["array", "preserve_keys"],
        parameter_types: &[Some("array"), Some("bool")],
        return_type: Some("array"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "array_search",
        parameters: &["needle", "haystack", "strict"],
        parameter_types: &[None, Some("array"), Some("bool")],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "array_slice",
        parameters: &["array", "offset", "length", "preserve_keys"],
        parameter_types: &[Some("array"), Some("int"), Some("int"), Some("bool")],
        return_type: Some("array"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "base64_decode",
        parameters: &["string", "strict"],
        parameter_types: &[Some("string"), Some("bool")],
    ...
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("string"), Some("string")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "chgrp",
        parameters: &["filename", "group"],
        parameter_types: &[Some("string"), None],
        return_type: Some("bool"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "chmod",
        parameters: &["filename", "permissions"],
        parameter_types: &[Some("string"), Some("int")],
        return_type: Some("bool"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "chown",
        parameters: &["filename", "user"],
        parameter_types: &[Some("string"), None],
        return_type: Some("bool"),
        is_variadic: false,
    },
    ...
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("string"), Some("string"), None],
        return_type: Some("bool"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "explode",
        parameters: &["separator", "string", "limit"],
        parameter_types: &[Some("string"), Some("string"), Some("int")],
        return_type: Some("array"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "extract",
        parameters: &["array", "flags", "prefix"],
        parameter_types: &[Some("array"), Some("int"), Some("string")],
        return_type: Some("int"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("string"), Some("bool"), None, Some("int"), Some("int")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "file_put_contents",
        parameters: &["filename", "data", "flags", "context"],
        parameter_types: &[Some("string"), None, Some("int"), None],
        return_type: Some("int"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "filter_has_var",
        parameters: &["input_type", "var_name"],
        parameter_types: &[Some("int"), Some("string")],
        return_type: Some("bool"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "filter_input",
        parameters: &["type", "var_name", "filter", "options"],
        parameter_types: &[Some("int"), Some("string"), Some("int"), None],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "filter_var",
        parameters: &["value", "filter", "options"],
        parameter_types: &[None, Some("int"), None],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "fgets",
        parameters: &["stream", "length"],
        parameter_types: &[None, Some("int")],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "fopen",
        parameters: &["filename", "mode", "use_include_path", "context"],
        parameter_types: &[Some("string"), Some("string"), Some("bool"), None],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "fwrite",
        parameters: &["stream", "data", "length"],
        parameter_types: &[None, Some("string"), Some("int")],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "hash",
        parameters: &["algo", "data", "binary", "options"],
        parameter_types: &[Some("string"), Some("string"), Some("bool"), Some("array")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "html_entity_decode",
        parameters: &["string", "flags", "encoding"],
        parameter_types: &[Some("string"), Some("int"), Some("string")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "htmlspecialchars",
        parameters: &["string", "flags", "encoding", "double_encode"],
        parameter_types: &[Some("string"), Some("int"), Some("string"), Some("bool")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "http_build_query",
        parameters: &["data", "numeric_prefix", "arg_separator", "encoding_type"],
        parameter_types: &[Some("array"), Some("string"), Some("string"), Some("int")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "implode",
        parameters: &["separator", "array"],
        parameter_types: &[Some("string"), Some("array")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "json_decode",
        parameters: &["json", "associative", "depth", "flags"],
        parameter_types: &[Some("string"), Some("bool"), Some("int"), Some("int")],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
        ...
        parameter_types: &[None, Some("int"), Some("int")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("string"), Some("string"), Some("int"), Some("string")],
        return_type: Some("int"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("string"), Some("int"), Some("int"), Some("string")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "method_exists",
        parameters: &["object_or_class", "method"],
        parameter_types: &[None, Some("string")],
        return_type: Some("bool"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "mkdir",
        parameters: &["directory", "permissions", "recursive", "context"],
        parameter_types: &[Some("string"), Some("int"), Some("bool"), None],
        return_type: Some("bool"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "nl2br",
        parameters: &["string", "use_xhtml"],
        parameter_types: &[Some("string"), Some("bool")],
        return_type: Some("string"),
        is_variadic: false,
    },
    ...
    InternalFunctionMetadata {
        ...
        parameters: &["object_or_class", "property"],
        parameter_types: &[None, Some("string")],
        return_type: Some("bool"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("string"), Some("array"), Some("int")],
        return_type: Some("array"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "preg_match_all",
        parameters: &["pattern", "subject", "matches", "flags", "offset"],
        parameter_types: &[
            Some("string"),
            Some("string"),
            None,
    ...
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("string"), None, None, Some("int"), None],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "preg_replace_callback",
        parameters: &["pattern", "callback", "subject", "limit", "count", "flags"],
        parameter_types: &[Some("string"), None, None, Some("int"), None, Some("int")],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "preg_split",
        parameters: &["pattern", "subject", "limit", "flags"],
        parameter_types: &[Some("string"), Some("string"), Some("int"), Some("int")],
        return_type: Some("array"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("float"), Some("float")],
        return_type: Some("float"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "random_int",
        parameters: &["min", "max"],
        parameter_types: &[Some("int"), Some("int")],
        return_type: Some("int"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "scandir",
        parameters: &["directory", "sorting_order", "context"],
        parameter_types: &[Some("string"), Some("int"), None],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "str_getcsv",
        parameters: &["string", "separator", "enclosure", "escape"],
        parameter_types: &[
            Some("string"),
            Some("string"),
            Some("string"),
    ...
    InternalFunctionMetadata {
        name: "str_ireplace",
        parameters: &["search", "replace", "subject", "count"],
    ...
    InternalFunctionMetadata {
        name: "str_pad",
        parameters: &["string", "length", "pad_string", "pad_type"],
        parameter_types: &[Some("string"), Some("int"), Some("string"), Some("int")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "str_repeat",
        parameters: &["string", "times"],
        parameter_types: &[Some("string"), Some("int")],
        return_type: Some("string"),
        is_variadic: false,
    },
    ...
    InternalFunctionMetadata {
        name: "strpos",
        parameters: &["haystack", "needle", "offset"],
        parameter_types: &[Some("string"), Some("string"), Some("int")],
        return_type: Some("int"),
        is_variadic: false,
    },
    ...
    InternalFunctionMetadata {
        name: "strip_tags",
        parameters: &["string", "allowed_tags"],
        parameter_types: &[Some("string"), Some("string")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("string"), Some("int"), Some("int")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "substr_replace",
        parameters: &["string", "replace", "offset", "length"],
        parameter_types: &[Some("string"), Some("string"), Some("int"), Some("int")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("string"), None, Some("string")],
        return_type: Some("string"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "sqrt",
        parameters: &["num"],
        parameter_types: &[Some("float")],
        return_type: Some("float"),
        is_variadic: false,
    },
    InternalFunctionMetadata {
        name: "strtotime",
        parameters: &["datetime", "base_timestamp"],
        parameter_types: &[Some("string"), Some("int")],
        return_type: Some("int"),
        is_variadic: false,
    },
    ...
    InternalFunctionMetadata {
        name: "touch",
        parameters: &["filename", "mtime", "atime"],
        parameter_types: &[Some("string"), Some("int"), Some("int")],
        return_type: Some("bool"),
        is_variadic: false,
    },
    ...
    InternalFunctionMetadata {
        ...
        parameter_types: &[Some("string"), Some("string"), Some("string")],
        return_type: None,
        is_variadic: false,
    },
    InternalFunctionMetadata {
    ...
    InternalFunctionMetadata {
        name: "wordwrap",
        parameters: &["string", "width", "break", "cut"],
        parameter_types: &[Some("string"), Some("int"), Some("string"), Some("bool")],
        return_type: Some("string"),
        is_variadic: false,
    },
...
fn internal_function_metadata(normalized_name: &str) -> Option<&'static InternalFunctionMetadata> {
    INTERNAL_FUNCTIONS
        .iter()
        .find(|metadata| metadata.name == normalized_name)
}

fn internal_function_signature(name: &str) -> Option<Signature> {
    let normalized_name = normalize_symbol_key(name);
    let metadata = internal_function_metadata(&normalized_name)?;
    ...
    Some(Signature {
        ...
        is_variadic: metadata.is_variadic,
        is_abstract: false,
        location: None,
        doc_summary: Some(format!(
...
fn internal_function_parameter_types(
    ...
    let type_names = internal_function_metadata(normalized_name)
        .map(|metadata| metadata.parameter_types)
        .unwrap_or(&[]);
...
fn internal_function_return_type(normalized_name: &str) -> Option<ComparableReturnType> {
    internal_function_metadata(normalized_name)
        .and_then(|metadata| metadata.return_type)
        .and_then(|type_name| comparable_parameter_type(type_name, None, &ImportMap::default()))
}
